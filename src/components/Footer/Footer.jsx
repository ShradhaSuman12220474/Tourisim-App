    ...
    <div className='footer-div'>
      <footer className="py-5">
        ...
        <ul className="list-unstyled d-flex">
            <li className="ms-3"><a class="link-dark" href="https://github.com/Ayush8418"><img alt="" /></a></li>
            <li className="ms-3"><a class="link-dark" href="https://www.linkedin.com/in/ayush-kumar271220048418/"><img alt="" /></a></li>
            <li className="ms-3"><a class="link-dark" href="https://x.com/AyushSingh9141"><img alt="" /></a></li>
        </ul>
        </div>
    </footer>
        </div>
